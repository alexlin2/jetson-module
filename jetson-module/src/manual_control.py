...
from mavros_msg import OverrideRCIn
import time
...
class ManualControl():
    ...
    def __init__(self):
        ...
        self.pub_cmd_vel = rospy.Publisher('/mavros/rc/OverrideRCIn', OverrideRCIn, queue_size = 1)
    ...
    def send_command(self, msg):
            ...
            throttle = map(self._steer_cache, -1.0, 1.0, 1300, 1700)
